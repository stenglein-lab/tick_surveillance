...
| `metadata` | The path to an excel spreadsheet containing sample metadata | `string` | None | True |  |
...
| `script_dir` |  | `string` | scripts/ |  | True |
| `initial_fastqc_dir` |  | `string` | ${params.outdir}/initial_fastqc/ |  | True |
| `post_trim_fastqc_dir` |  | `string` | ${params.outdir}/post_trim_fastqc/ |  | True |
| `trimmed_outdir` |  | `string` | ${params.outdir}/trimmed_fastq |  | True |
| `blast_outdir` |  | `string` | ${params.outdir}/blast |  | True |
| `refseq_dir` |  | `string` | /home/mdstengl/2023_1_issues/refseq/ |  | True |
| `singularity_pull_docker_container` |  | `boolean` |  |  | True |
...
| `email` |  | `string` | mark.stenglein@colostate.edu |  | True |
| `email_on_fail` |  | `string` | mark.stenglein@colostate.edu |  | True |
| `plaintext_email` |  | `string` |  |  | True |
| `monochrome_logs` |  | `string` |  |  | True |
| `hook_url` |  | `string` |  |  | True |
| `version` |  | `string` |  |  | True |
| `validate_params` |  | `string` |  |  | True |
| `python_requirements` |  | `string` | /home/mdstengl/2023_8_dsl2_dev/lib/requirements.txt |  | True |
| `QC_and_summary_stats` |  | `string` | results/QC_and_summary_stats |  | True |
| `cutadapt_trim_reports` |  | `string` | results/QC_and_summary_stats/cutadapt_trim_reports |  | True |
| `multiQC_reports` |  | `string` | results/QC_and_summary_stats/multiqc |  | True |
| `schema_ignore_params` |  | `string` |  |  | True |
| `R_tar_dir` |  | `string` | /home/mdstengl/2023_8_dsl2_dev/lib/R/ |  | True |
| `show_hidden_params` |  | `string` |  |  |  |
| `filter_unassigned_seq` |  | `string` | Borrelia,Borreliella,Babesia,Anaplasma,Ehrlichia |  |  |
